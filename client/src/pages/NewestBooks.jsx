...
function BookCard({ book }) {
  ...
  return (
    <div
      ...
      className="flex flex-col h-full border border-zinc-800 bg-zinc-900 hover:border-zinc-600 transition-all shadow-lg hover:shadow-zinc-800/50 p-3 sm:p-4 md:p-5 shrink-0 w-56 sm:w-64 md:w-72 rounded-xl cursor-pointer"
    >
      ...
      <h4 className="font-bold mt-3 text-sm md:text-base text-white line-clamp-1">
        {book.title}
      </h4>
      <p className="text-xs md:text-sm text-zinc-400 mb-2 line-clamp-1">
        {book.author || " "}
      </p>
...
function NewestBooks() {
  ...
  useEffect(() => {
    fetch("https://dersan-book-marketplace.onrender.com/api/listings?sort=newest")
      .then((res) => res.json())
  ...
  return (
    <div className="bg-zinc-950 border-t border-zinc-800 px-4 md:px-8 lg:px-12 py-12">
