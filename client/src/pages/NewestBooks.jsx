...
function BookCard({ book }) {
  ...
  return (
    <div className="flex flex-col h-full border border-zinc-800 bg-zinc-900 hover:border-zinc-600 transition-all shadow-lg hover:shadow-zinc-800/50 p-3 sm:p-4 md:p-5 shrink-0 w-56 sm:w-64 md:w-72 rounded-xl">
